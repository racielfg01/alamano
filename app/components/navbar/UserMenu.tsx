  ...
  return (
    <div className="relative">
      <div className="flex flex-row items-center gap-3">
        ...
        <div
          className="border-[1px] w-full md:w-auto p-2 rounded-full shadow-sm 
    hover:shadow-md transition cursor-pointer"
      ...
      overflow-hidden right-0 top-12 text-sm">
          <div className='flex flex-col cursor-pointer'>
            {currentUser ? (
              <>
                <MenuItem onClick={() => router.push("/ordenes")} label="Panel" />
                <MenuItem onClick={() => router.push("/ordenes")} label="Órdenes" />
                <MenuItem onClick={() => router.push("/favoritos")} label="Favoritos" />
                <MenuItem onClick={() => router.push("/reservations")} label="Reservaciones" />
                <MenuItem onClick={() => router.push("/properties")} label="Proveedor" />
                <MenuItem onClick={rentModal.onOpen} label="Agregar producto / servicio" />
                <hr />
